...
const Privacy = () => {
  ...
  const handleNavClick = (e, target) => {
    ...
    if (isAuthenticated) {
      ...
      else if (target === "about") navigate("/about"); // Assuming about page exists
      else navigate("/login");
    } else {
  ...
  // Show loading while checking auth (matches buyer_dashboard style)
    ...
    <>
      <style>{`
        * { box-sizing: border-box; }
        ...
        .privacy-section p { margin-bottom: 15px; line-height: 1.6; }
        .privacy-section ul { margin-bottom: 15px; padding-left: 20px; }
